...
exports.Utils = exports.InstanceManager = exports.CurrencyId = exports.TraderId = exports.InitStage = void 0;
...
class Utils {
    static modName = "ImmersiveDaylightCycle";
    //useful paths
    static modPath = path.normalize(path.join(__dirname, ".."));
    static profilePath = path.normalize(path.join(__dirname, "..", "..", "..", "profiles"));
    static modsFolderPath = path.normalize(path.join(__dirname, "..", ".."));
    ...
    static writeJson(jsonString, targetPath, useRawPath = false) {
        let filePath;
        if (useRawPath) {
            filePath = targetPath;
        }
...
exports.Utils = Utils;
//# sourceMappingURL=instance_manager.js.map